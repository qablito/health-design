...
| TM-005 | atacante administrativo | cuenta superadmin comprometida | impersona y cambia datos | compromiso total | todos los perfiles y reglas | planificado: AAL2, indicador persistente y log privado | no implementado; acceso total es requisito | MFA obligatorio, reautenticación, actor original/efectivo y alertas | log de impersonación y cambios masivos | media | crítica | critical |
